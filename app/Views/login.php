        <div class="logo_menu_div container-fluid clearfix " style="background-color: rgb(255, 255, 255); border-bottom-width: 0px; display: block;">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-12 col-md-12">
                        <div style="height:30px;" class="input-group pull-right">
                            <input type="text" style="background-color: #fcfcfc;height: 30px !important;border: solid 1px #ddd !important;border-top-left-radius: 3px;border-bottom-left-radius: 3px;box-shadow: none;" placeholder="Search any term, company or product..." name="search" id="full_search_input" value="" class="form-control">
                ...
                <div class="center-block text-center google_ad_nav" style="padding:8px 0;">
                    ...
                    <script type="text/javascript">
                        ...
                        if (browName == 'Netscape') {
                            document.write('<s' + 'cript lang' + 'uage="jav' + 'ascript" src="https://www.electricityforum.com/banmanpro/A.aspx?ZoneID=' + ZoneID + '&amp;Task=Get&amp;IFR=False&amp;Browser=NETSCAPE4&amp;Secure=True&amp;PageID=11064&amp;SiteID=' + SiteID + '&amp;Random=' + browDateTime + '&amp;wd=' + wd + '">');
                            document.write('</' + 'scr' + 'ipt>');
                        }
                        if (browName != 'Netscape') {
                            document.write('<s' + 'cript lang' + 'uage="jav' + 'ascript" src="https://www.electricityforum.com/banmanpro/A.aspx?ZoneID=' + ZoneID + '&amp;Task=Get&amp;IFR=False&amp;Secure=True&amp;PageID=11064&amp;SiteID=' + SiteID + '&amp;Random=' + browDateTime + '&amp;wd=' + wd + '">');
                            document.write('</' + 'scr' + 'ipt>');
                        }
                        // 
                        -->
                    </script>
                    <script language="javascript" src="https://www.electricityforum.com/banmanpro/A.aspx"></script><a href="https://www.electricityforum.com/banmanpro/A.aspx?Task=Click&amp;ZoneID=1&amp;CampaignID=134&amp;AdvertiserID=86&amp;BannerID=572&amp;SiteID=1&amp;RandomNumber=1805664358&amp;Keywords=" target="_Blank" rel="nofollow"></a><br>
                    <!-- End -  Site: EF Zone: EF-728X90 -->
                </div>
            </div>
        </div>
        </div>
